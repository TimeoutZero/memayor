angular.module("MeMayor.factories")
.factory 'hAlert', ($timeout, SweetAlert, $window, $translate) ->
  ...
  return alert = {
    ...
    open: (options = {}, fn) ->
      config =
        ...
        cancelButtonText: $translate.instant("CRUD.ALERTS.REMOVE.CONFIRM.CANCEL")
        confirmButtonColor: '#2196f3'
        confirmButtonText: $translate.instant("CRUD.ALERTS.REMOVE.CONFIRM.OK")
        closeOnConfirm: !fn?
